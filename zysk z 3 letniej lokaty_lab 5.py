...
print("\nI Sposób", "\nZysk z 3 letniej lokaty bankowej, wynosi:", round(deposit - inwestowane_srodki ,2), "zl.") # z użyciem zaokrlągenia, do dwóch miejsc po przecinku
...
# obliczenie kapitalizacji odsetek/zysku z użyciem złożonego operatora przypisania
deposit *= (1+oprocentowanie) #tu mamy kapitalizacje odsetek/zysk po pierwszym roku
deposit *= (1+oprocentowanie) #tu mamy kapitalizacje odsetek/zysk po drugim roku, powiększonym o kapitalizacje po pierwszym roku
deposit *= (1+oprocentowanie) #tu mamy kapitalizacje odsetek/zysk po trzecim roku, powiększonym o kapitalizacje po drugim roku

# Finalny zysk z 3 letniej lokaty bankowej
print('\nII Sposób', "\nZysk z 3 letniej lokaty bankowej, wynosi:", round(deposit - inwestowane_srodki ,2), "zl.")
