...
a = 4. # 'a' i 'b' to zmienne typu float - i one będę określać u nas dwie przyprostokątne
b = 3.

# c **2 = a**2 + b **2 # ale musimy teraz się pozbyć potęgowania do kwadratu, z przeciwprostokatnej 'c'
